//TicTacToe Client file, the user only deals with this.
import java.io.*;
...
public class Client extends UnicastRemoteObject implements TicTacToe{
    private static final long serialVersionUID = 1L;
    public TicTacToe server;
    ...
    protected Client() throws MalformedURLException, RemoteException, NotBoundException, IOException  {
        ...
        this.server = (TicTacToe) Naming.lookup("rmi://localhost/RMIServer");
