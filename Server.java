// TicTacToe Server file. Server is always up and running and can handle multiple games at once.
import java.io.* ;
import java.net.* ;
import java.util.* ;
import java.rmi.*;
...
public class Server extends UnicastRemoteObject implements TicTacToe {
    public static final long serialVersionUID = 1L ;
    public Vector<TicTacToe> clientList;
    public Vector<TicTacToe> waitList;
    ...
    {
        clientList = new Vector<TicTacToe>();
        waitList = new Vector<TicTacToe>();
        Games = new Vector<Game>();
    }

    public void joinGame(TicTacToe client) {
        this.clientList.add(client);
        this.checkGamePlay(client);
    }

    public void checkGamePlay(TicTacToe client) {
        if(this.waitList.size()>0)
        {
            TicTacToe pl=this.waitList.elementAt(0);
    ...
    public void startGame(TicTacToe player1, TicTacToe player2)
    {
        try {
...
class Game {
    ...
    Game(TicTacToe player1_, TicTacToe player2_) {
